package com.SimplePractice.Utilities;
...
public class Reporting extends TestListenerAdapter {
	...
	public void onStart(ITestContext testContext)
	{
		...
		htmlReporter=new ExtentHtmlReporter(System.getProperty("user.dir")+"\\TestReport\\"+repName+".html");
		...
		htmlReporter.config().setDocumentTitle("SimplePractice Test report");
